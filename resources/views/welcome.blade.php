        ...
        <div class="flex-grow p-8">
            <div class="bg-gray-700 rounded-lg shadow-lg p-6 mb-8">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-300">10</p>
                    </div>
                    <div>
                        <p class="text-gray-400">Completed Projects</p>
                        <p class="text-3xl text-gray-300 font-bold">6</p>
                    </div>
                    <div>
                        <p class="text-gray-400">Ongoing Projects</p>
                        <p class="text-3xl text-gray-300 font-bold">4</p>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gray-700 rounded-lg shadow-lg p-6">
                    <h3 class="text-lg text-gray-300 font-bold mb-4">Project A</h3>
                    <p class="text-gray-400">Status: In Progress</p>
                    <p class="text-gray-400 mt-2">Tasks: 15</p>
                    <p class="text-gray-400">Team Members: 5</p>
                </div>
                <!-- Project Card (Dummy Data) -->
                <div class="bg-gray-700 rounded-lg shadow-lg p-6">
                    <h3 class="text-lg text-gray-300 font-bold mb-4">Project A</h3>
